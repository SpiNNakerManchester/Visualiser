...
IF NOT EXIST "%VIRTUAL_ENV%"\Lib\site-packages\cairo (
    mklink /D %VIRTUAL_ENV%\Lib\site-packages\cairo C:\Python2.7\Lib\site-packages\cairo\
)

IF NOT EXIST "%VIRTUAL_ENV%"\Lib\site-packages\gtk-2.0 (
    mklink /D %VIRTUAL_ENV%\Lib\site-packages\gtk-2.0 C:\Python2.7\Lib\site-packages\gtk-2.0\
)

IF NOT EXIST "%VIRTUAL_ENV%"\Lib\site-packages\pygtk.pth (
    mklink %VIRTUAL_ENV%\Lib\site-packages\pygtk.pth C:\Python2.7\Lib\site-packages\pygtk.pth
)
